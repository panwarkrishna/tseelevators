...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://tseelevators.com/goods-lift" },
};
...
export default function GoodsLiftPage() {
  return (
    <main className="w-full bg-white text-slate-900 selection:bg-[#D6362C] selection:text-white overflow-x-hidden">
      <GlobalPageHero title="Goods Lift" description="Heavy-duty goods lifts built for safe and efficient transportation of materials and equipment." backgroundImage="../product-img/goods-lift.webp" badgeText="Industrial Lifts" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
            <div className="lg:col-span-5 space-y-6">
              <div className="group relative overflow-hidden rounded-3xl border border-slate-200 bg-slate-100 shadow-xl aspect-[4/3]">
                <Image src="../product-img/goods-lift.webp" alt="Goods Lift Manufacturers in Delhi" title="Goods Lift Manufacturers in Delhi" fill priority className="object-cover object-center transition-transform duration-700 ease-out group-hover:scale-105" />

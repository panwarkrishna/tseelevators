...
export const metadata: Metadata = {
  title: "Residential Lift – TSE Elevators",
  description: "Reliable and comfortable residential lifts designed for homes, apartments, and housing societies.",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-start">
            ...
            <div className="lg:col-span-6 space-y-6 sm:space-y-8">
              <div>
                ...
                <h2 className="text-2xl sm:text-4xl font-extrabold text-slate-900 tracking-tight">Residential Lift</h2>
                <p className="mt-3 sm:mt-4 text-slate-600 text-sm sm:text-base leading-relaxed">Reliable and comfortable residential lifts designed for homes, apartments, and housing societies with a focus on safety and smooth operation.</p>
              </div>
            </div>
          </div>
        </div>

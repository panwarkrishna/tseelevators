...
export default function PassengerLiftPage() {
  return (
    <main className="w-full bg-white text-slate-900 selection:bg-[#D6362C] selection:text-white overflow-x-hidden">
      <GlobalPageHero title="Lift Manufacturers in Punjab" description="Reliable Lift Manufacturers in Punjab" backgroundImage="../lift-location/9.jpg" badgeText="Elevators" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
            <div className="lg:col-span-5 space-y-6">
              <div className="group relative overflow-hidden rounded-3xl border border-slate-200 bg-slate-100 shadow-xl aspect-[4/3]">
                <Image src="../lift-location/9.jpg" alt="Lift Manufacturers in Punjab"  title="Lift Manufacturers in Punjab" fill priority className="object-cover object-center transition-transform duration-700 ease-out group-hover:scale-105" />
...
<ul className="list-disc list-outside pl-5 text-black leading-relaxed space-y-1">
  ...
  <li>Designs that meet all your requirements</li>

...
export default function PassengerLiftPage() {
  return (
    <main className="w-full bg-white text-slate-900 selection:bg-[#D6362C] selection:text-white overflow-x-hidden">
      <GlobalPageHero title="Passenger Lift" description="Modern passenger lifts engineered to provide safe, smooth, and efficient vertical transportation." backgroundImage="../product-img/passenger-lift.webp" badgeText="Elevators" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
            <div className="lg:col-span-5 space-y-5">
              <div className="group relative overflow-hidden rounded-3xl border border-slate-200 bg-slate-100 shadow-xl aspect-[4/3]">
                <Image src="../product-img/passenger-lift.webp" alt="Passenger Lift Manufacturers in Delhi"  title="Passenger Lift Manufacturers in Delhi" fill priority className="object-cover object-center transition-transform duration-700 ease-out group-hover:scale-105" />
            ...
            <div className="lg:col-span-7 space-y-7 sm:space-y-7">
              <div>
              <h1 className="text-2xl sm:text-4xl font-extrabold text-slate-900 tracking-tight mb-4">Passenger Lift</h1>
...
<h2 className="text-2xl sm:text-3xl font-bold text-slate-800 mt-8 mb-2">Best Passenger Lift Manufacturers in Delhi</h2>
<p className="text-md text-black">
...
<h3 className="text-2xl sm:text-2xl  font-bold text-slate-800 mt-8 mb-2">Reliable Passenger Elevator Suppliers Across Delhi-NCR</h3>
<p className="text-md text-black pb-4 m-0">

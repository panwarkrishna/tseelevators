          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-start">
            <div className="lg:col-span-6 space-y-6">
              <div className="group relative overflow-hidden rounded-3xl border border-slate-200 bg-slate-100 shadow-xl aspect-[4/3]">
                <Image src="https://aditechinfo.com/tseelevators/product-img/commercial-lift.webp" alt="Commercial Lift for offices, hotels, hospitals and commercial buildings" fill priority className="object-cover object-center transition-transform duration-700 ease-out group-hover:scale-105" />
                <div className="absolute inset-0 bg-gradient-to-t from-slate-950/70 via-transparent to-transparent pointer-events-none" />
                <div className="absolute bottom-6 left-6 z-10"><span className="rounded-full bg-[#D6362C] px-3.5 py-1 text-[11px] font-bold uppercase tracking-wider text-white shadow-md">Heavy Duty</span></div>
              </div>
            ...
            <div className="lg:col-span-6 space-y-6 sm:space-y-8">
              <div>
                ...
                <p className="mt-3 sm:mt-4 text-slate-600 text-sm sm:text-base leading-relaxed">High-performance commercial lifts designed for offices, hotels, shopping centres, hospitals, and other high-traffic commercial environments.</p>
              </div>

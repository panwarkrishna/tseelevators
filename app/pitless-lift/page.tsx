...
export const metadata: Metadata = {
  title: "Pitless Lift – TSE Elevators",
  description: "Space-efficient pitless lift solutions designed for buildings where conventional deep lift pits are impractical.",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-start">
            ...
            <div className="lg:col-span-6 space-y-6 sm:space-y-8">
              <div>
                ...
                <p className="mt-3 sm:mt-4 text-slate-600 text-sm sm:text-base leading-relaxed">Space-efficient pitless lift solutions designed for buildings where conventional deep lift pits are difficult or impractical to install.</p>
              </div>

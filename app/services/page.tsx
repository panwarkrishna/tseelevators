...
export default function ServicesPage() {
  return (
     <main className="w-full bg-white text-slate-900 selection:bg-[#D6362C] selection:text-white overflow-x-hidden">
      <GlobalPageHero title="Services" description="Efficient hydraulic lift solutions ideal for low-rise buildings and villas requiring smooth movement." backgroundImage="https://aditechinfo.com/tseelevators/product-img/hydraulic-lift.webp" badgeText="Services" />

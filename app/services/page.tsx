...
export default function ServicesPage() {
  return (
     <main className="w-full bg-white text-slate-900 selection:bg-[#D6362C] selection:text-white overflow-x-hidden">
      <GlobalPageHero title="Services" description="Efficient hydraulic lift solutions ideal for low-rise buildings and villas requiring smooth movement." backgroundImage="../services/services-img.webp" badgeText="Services" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12  items-start">
            <div className="lg:col-span-5 space-y-5">
              <div className="group relative overflow-hidden rounded-3xl border border-slate-200 bg-slate-100 shadow-xl aspect-[4/3]">
                <Image src="../services/services-img.webp" alt="Trusted Elevator Services in Delhi" title="Trusted Elevator Services in Delhi" fill priority className="object-cover object-center transition-transform duration-700 ease-out group-hover:scale-105" />

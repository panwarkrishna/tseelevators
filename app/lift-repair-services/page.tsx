...
export default function PassengerLiftPage() {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
            <div className="lg:col-span-5 space-y-6">
              <div className="group relative overflow-hidden rounded-3xl border border-slate-200 bg-slate-100 shadow-xl aspect-[4/3]">
                <Image src="../services/lift-repair1.webp" alt="Lift Repair Services in Delhi" title="Lift Repair Services in Delhi" fill priority className="object-cover object-center transition-transform duration-700 ease-out group-hover:scale-105" />
  ...
  <h3 className="text-2xl sm:text-2xl  font-bold text-slate-800 mt-8 mb-2">Fast Elevator Repair Services in Delhi-NCR</h3>
            <p className="text-black text-md sm:text-base leading-relaxed">We are a trusted provider of <strong>Elevator Repair Services in Delhi-NCR</strong> with experience. We provide Lift Repair Services in Delhi, Noida, Gurugram, Haryana and the surrounding areas. Here are some of the reasons why our customers keep choosing us for all their lift repair services.</p>

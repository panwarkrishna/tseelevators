...
export default function PassengerLiftPage() {
  return (
    <main className="w-full bg-white text-slate-900 selection:bg-[#D6362C] selection:text-white overflow-x-hidden">
      <GlobalPageHero title="Lift Maintenance" description="Modern Lift Maintenances engineered to provide safe, smooth, and efficient vertical transportation." backgroundImage="https://aditechinfo.com/tseelevators/product-img/passenger-lift.webp" badgeText="Elevators" />

...
export default function HomeLiftPage() {
  return (
    <main className="w-full bg-white text-slate-900 selection:bg-[#D6362C] selection:text-white overflow-x-hidden">
      <GlobalPageHero title="Home Lift" description="Compact and reliable domestic lifts designed for private homes, villas, and duplex residences." backgroundImage="../product-img/home-lift.webp" badgeText="Home Lifts" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
            <div className="lg:col-span-5 space-y-5">
              <div className="group relative overflow-hidden rounded-3xl border border-slate-200 bg-slate-100 shadow-xl aspect-[4/3]">
                <Image src="../product-img/home-lift.webp" alt="Home Lift Manufacturers in Delhi"  title="Home Lift Manufacturers in Delhi" fill priority className="object-cover object-center transition-transform duration-700 ease-out group-hover:scale-105" />

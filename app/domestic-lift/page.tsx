...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://tseelevators.com/domestic-lift" },
};
...
export default function DomesticLiftPage() {
  return (
    <main className="w-full bg-white text-slate-900 selection:bg-[#D6362C] selection:text-white overflow-x-hidden">
      <GlobalPageHero title="Domestic Lift" description="Compact and reliable domestic lifts designed for private homes and duplex residences." backgroundImage="../product-img/domestic.webp" badgeText="Home Lifts" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
            <div className="lg:col-span-5 space-y-5">
              <div className="group relative overflow-hidden rounded-3xl border border-slate-200 bg-slate-100 shadow-xl aspect-[4/3]">
                <Image src="../product-img/domestic.webp" alt="Domestic Lift Manufacturers in Delhi"  title="Domestic Lift Manufacturers in Delhi" fill priority className="object-cover object-center transition-transform duration-700 ease-out group-hover:scale-105" />
...
<h1 className="text-2xl sm:text-4xl font-extrabold text-slate-900 tracking-tight mb-4">Domestic Lift </h1>
...
<h2 className="text-2xl sm:text-3xl font-bold text-slate-800 mt-8 mb-2">Domestic Lift Manufacturers In Delhi</h2>
...
<h3 className="text-2xl sm:text-2xl font-bold text-slate-800 mt-8 mb-2">Trusted Domestic Elevator Suppliers In Delhi-NCR</h3>

...
const PRODUCTS: ProductItem[] = [
...

  {
    ...
    image:
      "../product-img/passenger-lift.webp",
    href: "/passenger-lift",
    altText:
...

  {
    ...
    image:
      "../product-img/commercial-lift.webp",
...

  {
    ...
    image:
      "../product-img/hydraulic-lift.webp",
    href: "/hydraulic-lift",
    altText:

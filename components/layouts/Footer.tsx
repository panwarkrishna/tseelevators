  ...
  return (
    <footer className="relative w-full bg-[#273b76] text-white font-sans border-t border-slate-200">
      ...
      <div className="border-b border-slate-100 bg-slate-50 py-8">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-6 px-5 sm:px-8 lg:flex-row lg:px-12">
      ...
      {/* Main Footer Grid */}
      <div className="relative z-10 mx-auto max-w-7xl px-5 py-5 sm:px-8 sm:py-8 lg:px-12 lg:py-10">
        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:gap-8">
          ...
          <div className="space-y-5 lg:col-span-3">
            ...
            <p className="text-xs leading-relaxed text-white sm:text-sm">
              We are the leading elevator manufacturers in Delhi NCR, offering
              high-performance residential, commercial, and industrial vertical
              transport solutions.
            </p>
            ...
            <div className="space-y-2.5 pt-1">
              ...
              <a
                ...
                className="flex items-center gap-2 text-xs font-semibold text-white transition-colors hover:text-[#D6362C] sm:text-sm"
              >
          ...
          <div className="lg:col-span-2">
            ...
            <h4 className="border-l-2 border-[#D6362C] pl-3 text-xs font-bold uppercase tracking-widest text-white">
              Useful Links
            </h4>
            ...
            <ul className="mt-4 space-y-2.5">
              {USEFUL_LINKS.map((link) => (
                <li key={link.label}>
                  <Link
                    href={link.href}
                    className="group flex items-center gap-2 text-xs text-white transition-colors hover:text-[#D6362C] sm:text-sm"
                  >
          ...
          <div className="space-y-6 lg:col-span-3">
            ...
            <div>
              ...
              <p className="mt-2.5 flex items-start gap-2.5 text-xs leading-relaxed text-white sm:text-sm">
                <MapPin className="mt-0.5 h-4 w-4 shrink-0 text-[#D6362C]" />

                <span>
                  Shop No.– 12, DDA Market, Lado Sarai New Delhi – 110030
                </span>
              </p>
            </div>
      ...
      <div className="border-t border-slate-200 bg-[#273b76] py-6">
        ...
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-4 px-5 text-xs text-white sm:flex-row sm:px-8 lg:px-12">

          <p>
            © 2026 TSE Shaft Elevators (I) Pvt Ltd. All Rights Reserved.
          </p>

          <button
            type="button"
            onClick={scrollToTop}
            className="flex cursor-pointer items-center gap-1.5 font-semibold text-white transition-colors hover:text-[#D6362C]"
          >

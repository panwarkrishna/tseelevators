    ...
    <footer className="relative overflow-hidden bg-[#253d74] text-white selection:bg-[#D6362C] selection:text-white">
      ...
      <div className="relative mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-[1.4fr_0.8fr_0.8fr_1fr_1fr]">
          ...
          <div className="space-y-6 md:col-span-2 lg:col-span-1 lg:max-w-sm">

            <Link
              href="/"
              title="TSE Shaft Elevators - Home"
            >
              <Image
                src="/Logo-new.webp"
            ...
            <p className="mt-2 text-sm leading-relaxed text-white">
              We are the leading Lift Manufacturers in Delhi, offering turnkey
              mobility solutions to Residential, Commercial, and Public
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="mt-0.5 text-xs leading-relaxed text-white">
                    Metro Station-Saket, Shop No.02, Opposite Blue Tokai,
                    Champa Gali, Lane No.3, Westend Marg, Near Saket,
                    Saidulajab, New Delhi, Delhi 110030
                  </p>
              ...
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="mt-0.5 text-xs leading-relaxed text-white">
                    S.C.O. No. - 635, Second Floor, TDI City, Near Regenta
                    Hotel, Sec-119, Mohali, PB
                  </p>
